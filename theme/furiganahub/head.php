...
<div id="hd">
    ...
    <div id="tnb">
        <ul>
            ...
            <li class="tnb_admin"><a href="/bbs/group.php?gr_id=issue"><b><i class="fa fa-bars" aria-hidden="true"></i> 이슈</b></a></li>
            <?php }  ?>
            <?php } else {  ?>
    ...
    <div id="hd_wrapper">
        ...
        <div id="logo">
            <a href="<?php echo G5_URL ?>"><img src="<?php echo G5_IMG_URL ?>/logo.jpg" alt="<?php echo $config['cf_title']; ?>">
        ...
        <ul id="hd_qnb">
            ...
            <!-- <li><a href="<?php echo G5_BBS_URL ?>/new.php"><i class="fa fa-history" aria-hidden="true"></i><span>글</span></a></li> -->
        </ul>
    </div>
