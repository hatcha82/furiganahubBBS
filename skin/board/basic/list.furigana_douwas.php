...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            if ($list[$i]['is_notice']) {// 공지사항
                ...
                $douwas_img =$list[$i]['wr_1'];
                echo "<img style='width:50px' src='$douwas_img'/>";
            }
             ?>
            </td>
    ...
    <fieldset id="bo_sch">
        ...
        <select name="sfl" id="sfl">
            ...
            <option value="wr_subject||wr_content||wr_8||wr_10"<?php echo get_selected($sfl, 'wr_subject||wr_content'); ?>>제목+내용</option>
